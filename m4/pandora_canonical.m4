...
#include <time.h>
  ...
  CC_LIBCASSANDRA_DEFS="-DLIBCASSANDRA_BUILD"

  AM_CFLAGS="${AM_CFLAGS} ${CC_WARNINGS} ${CC_PROFILING} ${CC_COVERAGE} ${CC_LIBCASSANDRA_DEFS}"
  AM_CXXFLAGS="${AM_CXXFLAGS} ${CXX_WARNINGS} ${CC_PROFILING} ${CC_COVERAGE} ${CC_LIBCASSANDRA_DEFS}"
